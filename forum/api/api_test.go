...
func TestGetPosts(t *testing.T) {
	...
	mock.ExpectQuery(`SELECT id, author, content, created_at, open, title, updated_at, proposal_ids`).WillReturnRows(
		sqlmock.NewRows([]string{"id", "author", "content", "created_at", "open", "title", "updated_at", "proposal_ids"}).

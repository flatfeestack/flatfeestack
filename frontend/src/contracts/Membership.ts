export const MembershipABI = [
  ...
  "function initialize(address _representative, address _whitelisterOne, address _whitelisterTwo, address _walletContract)",
  ...
  "function representative() view returns (address)",
  "function requestMembership() returns (bool)",
  "function setMembershipFee(uint256 newMembershipFee)",
  "function setRepresentative(address _adr) returns (bool)",

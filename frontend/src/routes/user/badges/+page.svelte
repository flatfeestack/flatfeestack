<script lang="ts">
  ...
  import { error, user } from "$lib/ts/mainStore";
  import type { Contributions, ContributionSummary } from "$lib/types/users";
  import { formatDay, formatBalance } from "$lib/ts/services";
  ...
  import { htmlLegendPlugin } from "$lib/ts/utils";

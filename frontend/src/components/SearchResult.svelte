  ...
  <div>
    {#if !$user.multiplier}
      <div class="container-col2 mx-2">
        ...
        <div
          class="container-small icons-div"
          id="multiplier-sponsor-amount-div"
        >
          1
          <svg
            id="multiplier-amount-coin"
            viewBox="0 0 20 20"
            xmlns="http://www.w3.org/2000/svg"
    ...
    {:else}
      <div class="container-small mx-2">
        ...
        <div class="container-col2">
          ...
          {#if !multiplier}
            <a
              class="icons-a"
              href={"#"}
              on:click|preventDefault={onMultiplier}
            >
              <svg
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"

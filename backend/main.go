...
func main() {
	...
	router.HandleFunc("PUT /users/me/multiplierDailyAmount/{amount}", middlewareJwtAuthUserLog(api2.UpdateMltplrDlyAmt))
	router.HandleFunc("PUT /users/me/clear/multiplierDailyAmount", middlewareJwtAuthUserLog(api2.ClearMltplrDlyAmt))

...
// Category "Issues" devided into issues (created by the user),
// issue comments (on issues created by the user) and commenter (comments of the user). all must sum up to 1

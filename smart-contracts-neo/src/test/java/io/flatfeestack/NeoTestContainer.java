...
public class NeoTestContainer extends GenericContainer<NeoTestContainer> {
    ...
    public static final String CONFIG_BASE_DIR = "node-config/";

    static final String CONFIG_FILE_SOURCE = CONFIG_BASE_DIR + "config.json";
    ...
    static final String RPCNEP17TRACKER_FILE_SOURCE = CONFIG_BASE_DIR + "rpcnep17tracker.config.json";
    static final String RPCNEP17TRACKER_FILE_DESTINATION = "/neo-cli/Plugins/RpcNep17Tracker/config.json";
